...
## Description
This is an optimized cuff script for ESX that allows players to handcuff and unhandcuff other players in FiveM.
...
1. 📥 Clone or download this repository. If you download the ZIP file, make sure to remove the `-main` from the folder name.
...
## Description
Ceci est un script de menottes optimisé pour ESX qui permet aux joueurs de menotter et de démenotter d'autres joueurs dans FiveM.
...
1. 📥 Clonez ou téléchargez ce dépôt. Si vous téléchargez le fichier ZIP, assurez-vous de retirer le `-main` du nom du dossier.
